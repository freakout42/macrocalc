_mc_ - MacroCALC is a Lotus 1-2-3 compatible character based spreadsheet that
...
_mc_ can act as a filter to use pipes to perform complex transforms on streams of data.
...
_mc_ itself is an os-independent ANSI-C source and lives in mc/.
